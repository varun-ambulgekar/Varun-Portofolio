...
const About = () => {
  return (
    <section id="about" className="section-padding bg-background-light dark:bg-background-dark transition-colors duration-300">
      <div className="container mx-auto">
        ...
        >
          <h2 className="heading text-center text-text-light dark:text-text-dark">About Me</h2>
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg md:text-xl text-text-light/80 dark:text-text-dark/80 mb-6">
          ...
          >
            <a
              ...
              download
              className="inline-flex items-center gap-2 px-6 py-3 bg-primary-light dark:bg-primary-dark text-text-dark rounded-lg hover:scale-105 transition-transform duration-300 shadow-lg"
            >
        ...
        >
          {[
            ...
            <div
              key={index}
              className="card text-center hover:bg-primary-light dark:hover:bg-primary-dark hover:text-text-dark group transition-all duration-300 bg-background-light dark:bg-background-dark border border-text-light/10 dark:border-text-dark/10"
            >
              <h3 className="text-3xl md:text-4xl font-bold mb-2 text-secondary-light dark:text-secondary-dark group-hover:text-text-dark">
                {stat.number}
              </h3>
              <p className="text-text-light/80 dark:text-text-dark/80 group-hover:text-text-dark/80">{stat.text}</p>
            </div>
          ))}
        </motion.div>
      </div>
